...
CREATE TABLE Cancelacion (
    ...
    CONSTRAINT fk_cancelacion_paciente FOREIGN KEY (id_paciente_cancelacion) REFERENCES test_turnosDB.paciente(ID_Paciente),
	CONSTRAINT fk_cancelacion_profesional FOREIGN KEY (id_profesional_cancelacion) REFERENCES test_turnosDB.profesional(ID_Profesional)
);
